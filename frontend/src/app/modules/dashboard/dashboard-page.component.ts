...
import { FinanceMonthSummaryComponent } from '../finanzas/components/finance-month-summary.component';

@Component({
  selector: 'app-dashboard-page',
  standalone: true,
  imports: [FinanceMonthSummaryComponent, CurrencyPipe, RouterLink, MatCardModule, MatButtonModule, MatIconModule, MatSnackBarModule],
